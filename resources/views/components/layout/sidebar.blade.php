<!-- Sidebar Navigation -->
<div id="sidebar" class="w-full md:w-64 bg-white shadow-lg md:h-screen md:sticky md:top-0 overflow-y-auto transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out fixed z-40 h-full">
    <div class="p-4 border-b">
        <h1 class="text-xl font-bold text-gray-800">Warehouse Stock</h1>
        <p class="text-sm text-gray-500">API Documentation</p>
    </div>
    <nav class="p-4 space-y-1">
        <a href="#overview" class="nav-link flex items-center">
            <i class="fas fa-home mr-2 w-5"></i> Overview
        </a>
        <a href="#setup" class="nav-link flex items-center">
            <i class="fas fa-tools mr-2 w-5"></i> Setup & Installation
        </a>
